...
export default function FromVendedor() {
    return (
        <>

            <div className="flex w-full justify-center items-center">
                <div className="w-[100%] relative">
                    <input className="peer w-full p-4 pt-6 pl-10 pr-4 bg-inherit border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed border-white focus:border-blue-700" type="number" placeholder="" name="cedulavendedor" id="cedulavendedor" />
            ...
            <div className="flex w-full justify-center items-center">
                <div className="w-[100%] relative">
                    <input className="peer w-full p-4 pt-6 pl-10 pr-4 bg-inherit border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed border-white focus:border-blue-700" type="text" placeholder="" name="usuario" id="usuario" />
            ...
            <div className="flex w-full justify-center items-center">
                <div className="w-[100%] relative">
                    <input className="peer w-full p-4 pt-6 pl-10 pr-4 bg-inherit border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed border-white focus:border-blue-700" type="text" placeholder="" name="contraseña" id="contraseña" />
            ...
            <div className="flex w-full justify-center items-center">
                <div className="w-[100%] relative">
                    <input className="peer w-full p-4 pt-6 pl-10 pr-4 bg-inherit border-2 rounded-md outline-none transition disabled:opacity-70 disabled:cursor-not-allowed border-white focus:border-blue-700" type="number" placeholder="" name="telefono" id="telefono" />
