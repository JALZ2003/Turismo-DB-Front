...
export default function Search({ visible, puntos, activo, setActivo, setTitulo, search, almuerzo, setAlmuerzo, ciudades, ciudad, setCiudad, departamentos, departamento, setDepartamento }) {
    return (
                ...
                !puntos ? (
                    ...
                    <>
                        ...
                        >
                            ...
                            <select ref={ciudad} onChange={() => setCiudad(ciudad.current.value?.trim())}
                            ...
                            >
                                {ciudades.map((each, index) => {
                                    return <option key={index}> {each.nombre_ciudad} </option>
                                })}
                        ...
                        >
                            ...
                            <select ref={departamento} onChange={() => setDepartamento(departamento.current.value?.trim())}
                                class="appearance-none hover:placeholder-shown:bg-blue-500 relative text-blue-400 bg-transparent ring-0 outline-none border border-neutral-500 placeholder-blue-700 text-sm font-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            >
                                {departamentos.map((each, index) => {
                                    return <option key={index}> {each.nombre_departamento} </option>
                                })}
